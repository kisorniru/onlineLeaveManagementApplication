				...
				<div id="sidebar-wrapper">
					<ul class="sidebar-nav">
						...
						<li>
							...
							?>
						<li>
							<a style="color:#DAA520;" href="Applications.php">Applications <span style="color:red"><?php if($row['COUNT(lIsRecomanded)'] != 0){ ?>[ New <?php echo $row['COUNT(lIsRecomanded)']; ?> ]<?php } ?></span></a>
						</li>
							<?php
							}
							$objLeaveApplication = new LeaveApplication();
											...
											<tbody>
												...
												?>
													<tr>
														...
														<td><button type="submit" value="<?php echo $row['lId'] ?>" name="btnRecomand" class="btn btn-success">Recomand</button>  <button type="submit" value="<?php echo $row['lId'] ?>" name="btnApplicationDetails" class="btn btn-success">Details</button></td>
