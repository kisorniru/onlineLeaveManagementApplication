                    ...
                    <div class="col-lg-12">
						...
						<form role="form" action="../controller/AddEmployeeController.php" method="post" >
							...
							<div class="form-group">
								...
								<?php
								echo "<table class='table table-bordered table-hover table-striped' name='subcat'><thead><tr class='success'><th>Employee Code</th><th>Name</th><th>Department</th><th>Designation</th><th>Action</th></tr></thead><tbody>";
